...
public final class BigIntegerVectorTest {
    ...
    public void negateShouldSucceed() {
        vectors.forEach(
                vector -> assertThat(vector.negate()).isEqualTo(vector.scalarMultiply(BigInteger.ONE.negate())));
    }
    ...
    public void scalarMultiplyWithMinusOneShouldBeEqualToNegated() {
        vectors.forEach(
                vector -> assertThat(vector.scalarMultiply(BigInteger.ONE.negate())).isEqualTo(vector.negate()));
    }
    ...
    public void taxicabDistanceSizesNotEqualShouldThrowException() {
        assertThatThrownBy(() -> zeroVector
                .taxicabDistance(BigIntegerVector.builder(differentSize).putAll(BigInteger.ZERO).build()))
                .isExactlyInstanceOf(IllegalArgumentException.class)
    ...
    public void euclideanDistanceSizesNotEqualShouldThrowException() {
        assertThatThrownBy(() -> zeroVector
                .euclideanDistance(BigIntegerVector.builder(differentSize).putAll(BigInteger.ZERO).build()))
                .isExactlyInstanceOf(IllegalArgumentException.class)
                .hasMessage("expected equal sizes but actual %s != %s", size, differentSize);
    }
    ...
    public void euclideanDistanceSizesNotEqualWithScaleAndRoundingModeShouldThrowException() {
        assertThatThrownBy(() -> zeroVector
                .euclideanDistance(BigIntegerVector.builder(differentSize).putAll(BigInteger.ZERO).build(), scale,
