...
public final class BigIntegerMatrixTest {
    ...
    public void traceOfZeroMatrixShouldBeEqualToZero() {
        assertThat(zeroSquareMatrix.trace().get()).isEqualTo(BigInteger.ZERO);
    }
    ...
    public void determinatOfZeroMatrixShouldBeEqualToZero() {
        assertThat(zeroSquareMatrix.determinant().get()).isEqualTo(BigInteger.ZERO);
    }

    @Test
    public void determinatOfIdentityMatrixShouldBeEqualToOne() {
        assertThat(identityMatrix.determinant().get()).isEqualTo(BigInteger.ONE);
    }
