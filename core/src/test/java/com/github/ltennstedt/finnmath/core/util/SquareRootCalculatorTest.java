...
public final class SquareRootCalculatorTest {
    ...
    public void newPrecisionNullShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(null)).isExactlyInstanceOf(NullPointerException.class)
            .hasMessage("precision");
    }

    @Test
    public void newPrecisionTooLowShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(BigDecimal.ZERO))
    ...
    public void newPrecisionTooHighShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(BigDecimal.ONE))
            .isExactlyInstanceOf(IllegalArgumentException.class)
    ...
    public void newScaleTooLowShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(-1, roundingMode))
    ...
    public void newAllPrecisionNullShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(null, validScale, roundingMode))
            .isExactlyInstanceOf(NullPointerException.class).hasMessage("precision");
    }

    @Test
    public void newAllPrecisionTooLowShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(BigDecimal.ZERO, validScale, roundingMode))
            .isExactlyInstanceOf(IllegalArgumentException.class)
            .hasMessage("expected precision in (0, 1) but actual 0");
    }
    ...
    public void newAllPrecisionTooHighShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(BigDecimal.ONE, validScale, roundingMode))
            .isExactlyInstanceOf(IllegalArgumentException.class)
            .hasMessage("expected precision in (0, 1) but actual 1");
    }
    ...
    public void newAllScaleTooLowShouldThrowException() {
        assertThatThrownBy(() -> new SquareRootCalculator(validPrecision, -1, roundingMode))
            .isExactlyInstanceOf(IllegalArgumentException.class).hasMessage("expected scale >= 0 but actual -1");
    }
    ...
    public void scientificNotationForSqrtExponentShouldBePowerOfTwo() {
        mathRandom.nextBigDecimals(10, 2, 10)
            .forEach(decimal -> assertThat(squareRootCalculator.scientificNotationForSqrt(decimal).getExponent() % 2)
                .isEqualTo(0));
    }
    ...
    public void toStringShouldSucceed() {
        final String expected = MoreObjects.toStringHelper(squareRootCalculator)
            .add("precision", SquareRootCalculator.DEFAULT_PRECISION).add("scale", SquareRootCalculator.DEFAULT_SCALE)
