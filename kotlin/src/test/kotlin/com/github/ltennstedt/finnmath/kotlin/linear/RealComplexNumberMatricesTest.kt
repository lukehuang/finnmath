...
class RealComplexNumberMatricesTest {
    private val bound = 10L
    private val scale = 2
    private val size = 4
    private val howMany = 10
    private val mathRandom = MathRandom(7)
    private val matrices = mathRandom.nextRealComplexNumberMatrices(bound, scale, size, size, howMany)
    private val others = mathRandom.nextRealComplexNumberMatrices(bound, scale, size, size, howMany)
