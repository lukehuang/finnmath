...
class SimpleComplexNumberVectorsTest {
    private val bound = 10L
    private val size = 4
    private val howMany = 10
    private val mathRandom = MathRandom(7)
    private val vectors = mathRandom.nextSimpleComplexNumberVectors(bound, size, howMany)
    private val others = mathRandom.nextSimpleComplexNumberVectors(bound, size, howMany)
