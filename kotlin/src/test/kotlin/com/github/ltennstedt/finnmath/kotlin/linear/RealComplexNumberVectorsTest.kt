...
class RealComplexNumberVectorsTest {
    private val bound = 10L
    private val scale = 2
    private val size = 4
    private val howMany = 10
    private val mathRandom = MathRandom(7)
    private val vectors = mathRandom.nextRealComplexNumberVectors(bound, scale, size, howMany)
    private val others = mathRandom.nextRealComplexNumberVectors(bound, scale, size, howMany)
