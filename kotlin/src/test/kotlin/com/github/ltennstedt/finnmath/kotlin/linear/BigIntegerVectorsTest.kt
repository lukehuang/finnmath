...
class BigIntegerVectorsTest {
    private val bound = 10L
    private val size = 4
    private val howMany = 10
    private val mathRandom = MathRandom(7)
    private val vectors = mathRandom.nextBigIntegerVectors(bound, size, howMany)
    private val others = mathRandom.nextBigIntegerVectors(bound, size, howMany)
