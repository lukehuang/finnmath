...
class BigIntegerMatricesTest {
    private val bound = 10L
    private val size = 4
    private val howMany = 10
    private val mathRandom = MathRandom(7)
    private val matrices = mathRandom.nextBigIntegerMatrices(bound, size, size, howMany)
    private val others = mathRandom.nextBigIntegerMatrices(bound, size, size, howMany)
