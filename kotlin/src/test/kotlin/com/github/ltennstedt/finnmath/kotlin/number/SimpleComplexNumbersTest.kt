...
class SimpleComplexNumbersTest {
    private val bound = 10L
    private val howMany = 10
    private val mathRandom = MathRandom(7)
    private val complexNumbers = mathRandom.nextSimpleComplexNumbers(bound, howMany)
    private val others = mathRandom.nextInvertibleSimpleComplexNumbers(bound, howMany)
