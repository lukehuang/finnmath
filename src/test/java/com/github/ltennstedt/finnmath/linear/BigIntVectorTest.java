...
public final class BigIntVectorTest {
  ...
  private static final BigIntVector zeroVector = BigIntVector.builder(size).putAll(BigInteger.ZERO)
      .build();
  ...
  public void addShouldSucceed() {
    vectors.forEach(vector -> {
      others.forEach(other -> {
        ...
        assertThat(vector.add(other)).isExactlyInstanceOf(BigIntVector.class)
  ...
  public void subtractShouldSucceed() {
    vectors.forEach(vector -> {
      others.forEach(other -> {
        ...
        assertThat(vector.subtract(other)).isExactlyInstanceOf(BigIntVector.class)
            .isEqualTo(builder.build());
      });
    });
  }
  ...
  public void taxicabDistanceSizesNotEqualShouldThrowException() {
    assertThatThrownBy(() -> {
      zeroVector
          .taxicabDistance(BigIntVector.builder(differentSize).putAll(BigInteger.ZERO).build());
    }).isExactlyInstanceOf(IllegalArgumentException.class)
  ...
  public void euclideanNormWithScaleAndRoundingModeShouldSucceed() {
    vectors.forEach(vector -> {
      assertThat(vector.euclideanNorm(scale, roundingMode)).isExactlyInstanceOf(BigDecimal.class)
          .isEqualTo(
              new SquareRootCalculator(scale, roundingMode).sqrt(vector.euclideanNormPow2()));
    });
  }
  ...
  public void dotProductShouldSucceed() {
    vectors.forEach(vector -> {
      others.forEach(other -> {
        ...
        assertThat(vector.dotProduct(other)).isExactlyInstanceOf(BigInteger.class)
            .isEqualTo(expected);
      });
    });
  }
  ...
  public void euclideanDistanceSizesNotEqualShouldThrowException() {
    assertThatThrownBy(() -> {
      zeroVector
          .euclideanDistance(BigIntVector.builder(differentSize).putAll(BigInteger.ZERO).build());
    }).isExactlyInstanceOf(IllegalArgumentException.class)
        .hasMessage("expected equal sizes but actual %s != %s", size, differentSize);
  }
  ...
  public void euclideanDistanceSizesNotEqualWithPrecisionShouldThrowException() {
    assertThatThrownBy(() -> {
      zeroVector.euclideanDistance(
          BigIntVector.builder(differentSize).putAll(BigInteger.ZERO).build(), precision);
    }).isExactlyInstanceOf(IllegalArgumentException.class)
        .hasMessage("expected equal sizes but actual %s != %s", size, differentSize);
  }
  ...
  public void euclideanDistanceSizesNotEqualWithScaleAndRoundingModeShouldThrowException() {
    assertThatThrownBy(() -> {
      zeroVector.euclideanDistance(
          BigIntVector.builder(differentSize).putAll(BigInteger.ZERO).build(), scale, roundingMode);
    }).isExactlyInstanceOf(IllegalArgumentException.class)
        .hasMessage("expected equal sizes but actual %s != %s", size, differentSize);
  }
  ...
  public void euclideanDistanceSizesNotEqualWithPrecisionAndScaleAndRoundingModeShouldThrowException() {
    assertThatThrownBy(() -> {
      zeroVector.euclideanDistance(
          BigIntVector.builder(differentSize).putAll(BigInteger.ZERO).build(), precision, scale,
          roundingMode);
    }).isExactlyInstanceOf(IllegalArgumentException.class)
        .hasMessage("expected equal sizes but actual %s != %s", size, differentSize);
  }
