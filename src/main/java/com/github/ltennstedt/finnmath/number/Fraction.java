...
public final class Fraction extends Number
  ...
  public Fraction(final BigInteger numerator, final BigInteger denominator) {
    ...
    checkArgument(!denominator.equals(BigInteger.ZERO), "expected denominator != 0 but actual %s",
        denominator);
  }
  ...
  /**
   * Compares this {@link Fraction} to the given one and returns an int which indicates which one is
   * less
   *
   * @param other
