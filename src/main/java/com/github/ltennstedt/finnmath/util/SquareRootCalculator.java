...
public final class SquareRootCalculator {
  ...
  public BigDecimal sqrt(final BigInteger integer) {
    ...
    checkArgument(integer.compareTo(BigInteger.ZERO) > -1, "expected integer >= 0 but actual %s",
        integer);
  ...
  public BigDecimal sqrt(final BigDecimal decimal) {
    ...
    checkArgument(decimal.compareTo(BigDecimal.ZERO) > -1, "expected decimal >= 0 but actual %s",
        decimal);
